...
public class RestaurantPool {
	...
	public static class CookerPool {
		private static final Queue<Cooker> cookerWaitList = new ConcurrentLinkedQueue<>();
		private static final List<Cooker> cookerBussList = Collections.synchronizedList(new LinkedList<>());
	...
	public static class OrderPool {
		private static final List<Order> unPayOrderList = Collections.synchronizedList(new LinkedList<>());
		private static final List<Order> commitOrderList = Collections.synchronizedList(new ArrayList<>());
